...
public class StickerSet extends TelegramType {
     ...
     */
    public StickerSet(String name, String title, StickerType stickerType, boolean isAnimated, boolean isVideo,
    ...
    public StickerSet(JSONObject jStickerSet) {
        ...
        stickerType = StickerType.valueOf(hTelegram.getString("sticker_type"));
     ...
     * No-any params required
     *
     * @return {@link #stickerType} instance as {@link StickerType}
     */
