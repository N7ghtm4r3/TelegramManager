...
import static com.tecknobit.telegrammanager.botapi.records.basetypes.chat.members.ChatMember.ChatMemberStatus.creator;
...
public class ChatMemberOwner extends ChatMember {
    ...
    public ChatMemberOwner(User user, boolean isAnonymous, String customTitle) {
        this(creator, user, isAnonymous, customTitle);
    }
