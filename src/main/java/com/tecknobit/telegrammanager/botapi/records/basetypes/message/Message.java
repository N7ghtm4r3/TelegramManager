...
import com.tecknobit.telegrammanager.botapi.managers.games.records.Game;
import com.tecknobit.telegrammanager.botapi.managers.identifiers.chat.records.Chat;
import com.tecknobit.telegrammanager.botapi.managers.identifiers.chat.records.MessageAutoDeleteTimerChanged;
import com.tecknobit.telegrammanager.botapi.managers.identifiers.chat.records.attachments.Dice;
import com.tecknobit.telegrammanager.botapi.managers.identifiers.chat.records.attachments.Poll;
import com.tecknobit.telegrammanager.botapi.managers.identifiers.chat.records.attachments.ProximityAlertTriggered;
import com.tecknobit.telegrammanager.botapi.managers.identifiers.content.records.*;
import com.tecknobit.telegrammanager.botapi.managers.identifiers.content.records.videochatstates.VideoChatEnded;
import com.tecknobit.telegrammanager.botapi.managers.identifiers.content.records.videochatstates.VideoChatParticipantsInvited;
import com.tecknobit.telegrammanager.botapi.managers.identifiers.content.records.videochatstates.VideoChatScheduled;
import com.tecknobit.telegrammanager.botapi.managers.identifiers.content.records.videochatstates.VideoChatStarted;
import com.tecknobit.telegrammanager.botapi.managers.identifiers.forum.records.*;
import com.tecknobit.telegrammanager.botapi.managers.identifiers.payments.records.Invoice;
import com.tecknobit.telegrammanager.botapi.managers.identifiers.payments.records.SuccessfulPayment;
import com.tecknobit.telegrammanager.botapi.managers.identifiers.stickers.records.Sticker;
import com.tecknobit.telegrammanager.botapi.managers.passport.records.PassportData;
import com.tecknobit.telegrammanager.botapi.managers.profile.records.Contact;
...
import com.tecknobit.telegrammanager.botapi.managers.profile.records.Venue;
