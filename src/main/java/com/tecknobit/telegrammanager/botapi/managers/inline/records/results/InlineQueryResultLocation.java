...
import com.tecknobit.telegrammanager.botapi.managers.inline.records.results.parents.*;
...
import static com.tecknobit.telegrammanager.botapi.managers.inline.records.results.parents.InlineQueryResult.InlineQueryResultType.location;
 ...
 */
public class InlineQueryResultLocation<T extends InputMessageContent.InputMessageContentType> extends InlineQueryResultCoordinated<T> {
     ...
     */
    public static <T extends InputMessageContent.InputMessageContentType> InlineQueryResultLocation<T> getInstance(JSONObject jItem) {
        if (jItem == null)
            return null;
        else
