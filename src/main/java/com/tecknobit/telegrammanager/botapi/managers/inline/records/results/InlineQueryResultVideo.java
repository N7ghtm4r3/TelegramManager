 ...
 */
public class InlineQueryResultVideo<T extends InputMessageContent.InputMessageContentType> extends InlineQueryResultCaptioned<T> {
     ...
     */
    public static <T extends InputMessageContent.InputMessageContentType> InlineQueryResultVideo<T> getInstance(JSONObject jItem) {
        if (jItem == null)
            return null;
        else
