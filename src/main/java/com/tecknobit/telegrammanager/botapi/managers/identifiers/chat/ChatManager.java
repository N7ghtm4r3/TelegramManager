package com.tecknobit.telegrammanager.botapi.managers.identifiers.chat;
...
import com.tecknobit.telegrammanager.botapi.managers.identifiers.chat.records.ChatPermissions;
...
import com.tecknobit.telegrammanager.botapi.managers.profile.records.UserProfilePhotos;
...
public class ChatManager extends TelegramIdentifierManager {
    ...
    public <T> T getFile(String fileId, ReturnFormat format) throws IOException {
        ...
        return TelegramFile.returnFile(sendGetRequest(GET_FILE_ENDPOINT, query), format);
    }
