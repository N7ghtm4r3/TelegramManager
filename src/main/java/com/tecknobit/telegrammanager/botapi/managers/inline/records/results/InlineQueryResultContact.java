...
import static com.tecknobit.telegrammanager.botapi.managers.inline.records.results.parents.InlineQueryResult.InlineQueryResultType.contact;
 ...
 */
public class InlineQueryResultContact<T extends InputMessageContent.InputMessageContentType> extends InlineQueryResult<T> {
     ...
     */
    public static <T extends InputMessageContent.InputMessageContentType> InlineQueryResultContact<T> getInstance(JSONObject jItem) {
        if (jItem == null)
            return null;
        else
