...
public class StickersManager extends TelegramIdentifierManager {
    ...
    public TelegramFile uploadStickerFile(User user, String sticker, Sticker.StickerFormat stickerFormat) throws IOException {
        return uploadStickerFile(user.getId(), sticker, stickerFormat, LIBRARY_OBJECT);
    }

    public <T> T uploadStickerFile(User user, String sticker, Sticker.StickerFormat stickerFormat,
                                   ReturnFormat format) throws IOException {
        return uploadStickerFile(user.getId(), sticker, stickerFormat, LIBRARY_OBJECT);
    }

    public TelegramFile uploadStickerFile(long userId, String sticker, Sticker.StickerFormat stickerFormat) throws IOException {
        return uploadStickerFile(userId, sticker, stickerFormat, LIBRARY_OBJECT);
    }

    public <T> T uploadStickerFile(long userId, String sticker, Sticker.StickerFormat stickerFormat,
                                   ReturnFormat format) throws IOException {
    ...
    public boolean createNewStickerSet(User user, String name, String title, Sticker.StickerFormat stickerFormat,
                                       InputSticker... stickers) throws IOException {
        return createNewStickerSet(user.getId(), name, title, stickerFormat, stickers);
    }

    public boolean createNewStickerSet(long userId, String name, String title, Sticker.StickerFormat stickerFormat,
                                       InputSticker... stickers) throws IOException {
