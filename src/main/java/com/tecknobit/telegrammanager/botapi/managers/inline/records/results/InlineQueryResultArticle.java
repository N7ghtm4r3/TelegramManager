...
import static com.tecknobit.telegrammanager.botapi.managers.inline.records.results.parents.InlineQueryResult.InlineQueryResultType.article;
 ...
 */
public class InlineQueryResultArticle<T extends InputMessageContent.InputMessageContentType> extends InlineQueryResultTitled<T> {
     ...
     */
    public static <T extends InputMessageContent.InputMessageContentType> InlineQueryResultArticle<T> getInstance(JSONObject jItem) {
        if (jItem == null)
            return null;
        else
