 ...
 */
public class InlineQueryResultVoice<T extends InputMessageContent.InputMessageContentType> extends InlineQueryResultCaptioned<T> {
     ...
     */
    public static <T extends InputMessageContent.InputMessageContentType> InlineQueryResultVoice<T> getInstance(JSONObject jItem) {
        if (jItem == null)
            return null;
        else
