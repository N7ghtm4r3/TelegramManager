...
import static com.tecknobit.telegrammanager.botapi.managers.inline.records.results.parents.InlineQueryResult.InlineQueryResultType.venue;
 ...
 */
public class InlineQueryResultVenue<T extends InputMessageContent.InputMessageContentType> extends InlineQueryResultCoordinated<T> {
     ...
     */
    public static <T extends InputMessageContent.InputMessageContentType> InlineQueryResultVenue<T> getInstance(JSONObject jItem) {
        if (jItem == null)
            return null;
        else
