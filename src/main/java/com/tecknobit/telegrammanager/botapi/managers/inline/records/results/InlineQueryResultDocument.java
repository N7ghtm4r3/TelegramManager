...
import com.tecknobit.telegrammanager.botapi.managers.inline.records.results.parents.InlineQueryResultThumbnailed;
 ...
 */
public class InlineQueryResultDocument<T extends InputMessageContent.InputMessageContentType> extends InlineQueryResultThumbnailed<T> {
     ...
     */
    public static <T extends InputMessageContent.InputMessageContentType> InlineQueryResultDocument<T> getInstance(JSONObject jItem) {
        if (jItem == null)
            return null;
        else
