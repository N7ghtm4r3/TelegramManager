 ...
 */
public class InlineQueryResultAudio<T extends InputMessageContent.InputMessageContentType> extends InlineQueryResultCaptioned<T> {
     ...
     */
    public static <T extends InputMessageContent.InputMessageContentType> InlineQueryResultAudio<T> getInstance(JSONObject jItem) {
        if (jItem == null)
            return null;
        else
