...
public class InputSticker extends TelegramType {
    ...
    /**
     * {@code maskPosition} position where the mask should be placed on faces. For {@link Sticker.StickerType#mask} stickers only
     */
     ...
     * For {@link Sticker.StickerType#regular} and {@link Sticker.StickerType#custom_emoji} stickers only
     */
     ...
     * @param sticker:the   added sticker
     * @param emojiList:    list of 1-20 emoji associated with the sticker
     * @param maskPosition: position where the mask should be placed on faces. For {@link Sticker.StickerType#mask} stickers only
     * @apiNote this constructor is useful when you need to pass this class as parameter for the requests
     */
