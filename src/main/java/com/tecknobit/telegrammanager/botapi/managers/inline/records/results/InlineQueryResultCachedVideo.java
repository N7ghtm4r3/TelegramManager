...
import static com.tecknobit.telegrammanager.botapi.managers.inline.records.results.parents.InlineQueryResult.InlineQueryResultType.video;
 ...
 */
public class InlineQueryResultCachedVideo<T extends InputMessageContent.InputMessageContentType> extends InlineQueryResultCaptioned<T> {
     ...
     */
    public static <T extends InputMessageContent.InputMessageContentType> InlineQueryResultCachedVideo<T> getInstance(JSONObject jItem) {
        if (jItem == null)
            return null;
        else
