...
import com.tecknobit.telegrammanager.botapi.managers.identifiers.content.records.Audio;
import com.tecknobit.telegrammanager.botapi.managers.identifiers.content.records.TelegramDocument;
...
public class ContentManager extends TelegramIdentifierManager {
     ...
     *                          </li>
     *                          <li>
     *                               {@code "type"} -> poll type - [{@link Poll.PollType}, default {@link Poll.PollType#regular}]
     *                          </li>
     *                          <li>
    ...
    public boolean sendChatAction(Chat.ChatActionValue action) throws IOException {
    ...
    @Wrapper
    @RequestPath(method = POST, path = "sendChatAction")
    public boolean sendChatAction(Chat.ChatActionValue action, long messageThreadId) throws IOException {
        return sendChatAction(mChatId, action, -1);
    }
     ...
     */
    @RequestPath(method = POST, path = "sendChatAction")
    public <T> boolean sendChatAction(T chatId, Chat.ChatActionValue action) throws IOException {
     ...
     */
    @RequestPath(method = POST, path = "sendChatAction")
    public <T> boolean sendChatAction(T chatId, Chat.ChatActionValue action, long messageThreadId) throws IOException {
