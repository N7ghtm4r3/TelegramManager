...
import static com.tecknobit.telegrammanager.botapi.managers.inline.records.results.parents.InlineQueryResult.InlineQueryResultType.sticker;
 ...
 */
public class InlineQueryResultCachedSticker<T extends InputMessageContent.InputMessageContentType> extends InlineQueryResult<T> {
     ...
     */
    public static <T extends InputMessageContent.InputMessageContentType> InlineQueryResultCachedSticker<T> getInstance(JSONObject jItem) {
        if (jItem == null)
            return null;
        else
