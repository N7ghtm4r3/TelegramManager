...
import static com.tecknobit.telegrammanager.botapi.managers.inline.records.results.InlineQueryResultGif.ThumbnailMimeType.IMAGE_JPEG;
 ...
 */
public class InlineQueryResultGif<T extends InputMessageContent.InputMessageContentType> extends InlineQueryResultCaptioned<T> {
     ...
     */
    public static <T extends InputMessageContent.InputMessageContentType> InlineQueryResultGif<T> getInstance(JSONObject jItem) {
        if (jItem == null)
            return null;
        else
